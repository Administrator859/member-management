...
while tries_flag != "Close the program" :
        ...
        print("-----------------------------------------")
        print("-$ 1. for Admin mode                    |\n-$ 2. for member mode                   |")
        print("-----------------------------------------")
        Admin_user_mode = input("Enter your mode : ") 
        

        if Admin_user_mode == "1" :																			
                        print("*****************************************\n|       #-Welcome to AdMain mode-#       |\n*****************************************")
                        Password = input("Please enter your password : ")
                        while True :
                                
                                if Password == "admin941330" :
                                        print("-----------------------------------------")
                                        print("-$ 1. To manage members                 |\n-$ 2. To manage downline coaches        |\n-$ 3. To manage appointments            |\n-$ E. To be back                        |")
                                        print("-----------------------------------------")
                                        ...
                                        if AdminOptions == "1" :															
                                                        print("-----------------------------------------")
                                                        print("-$ 1. To add new member 	       |")
                                                        print("-$ 2. To display member 	       |")
                                                        print("-$ 3. To delete member data            |")
                                                        print("-$ 4. To edit member data              |")
                                                        print("-$ E. To Back      		       |")
                                                        print("-----------------------------------------")
                                                        ...
                                                        if Admin_choice == "1" : 										
                                                                                try :
                                                                                        ...
                                                                                        Program=input("Enter member program                : ")
                                                                                        ...
                                                                                        Members_DataBase[member_ID]=[Program,CoachName,Name,Age,Gender,Address,OriginalWeight,CurrentWeight,PhoneNumber]
                                                                                ...
                                                                                try :		
                                                                                        ...
                                                                                        print("member is in "+Members_DataBase[member_ID][0]+" program")
                                                                                ...
                                                                                try:            
                                                                                        ...
                                                                                        while True:
                                                                                                print("------------------------------------------")
                                                                                                print("-$ 1. To edit member Program:            |")
                                                                                                print("-$ 2. To edit Coach for program:         |")
                                                                                                print("-$ 3. To edit member Name:               |")
                                                                                                print("-$ 4. To edit member Age:                |")
                                                                                                print("-$ 5. To edit member Gender:             |")
                                                                                                print("-$ 6. To edit member Address:            |")
                                                                                                print("-$ 7. To edit member Current Weight:     |")
                                                                                                print("-$ 8. To edit member Phone Number:       |")
                                                                                                print("-$ E. To be Back:                        |")
                                                                                                print("------------------------------------------")
                                                                                                Admin_choice = input("Enter your choice : ")
                                                                                                Admin_choice = Admin_choice.upper()
                                                                                                if Admin_choice == "1" :
                                                                                                        Members_DataBase[member_ID][0]=input("\nEnter member program : ")
                                                                                                        print("----------------------Member Program edited successfully----------------------")
                                                ...
                                                print("-----------------------------------------")
                                                print("-$ 1. To add new coach                  |")
                                                print("-$ 2. To display coach                  |")
                                                print("-$ 3. To delete coach  data             |")
                                                print("-$ 4. To edit coach  data               |")
                                                print("-$ E. To be back                        |")
                                                print("-----------------------------------------")
                                                Admin_choice = input ("Enter your choice : ")
                                                Admin_choice = Admin_choice.upper()
                                                ...
                                                if Admin_choice == "1" : 											
                                                                ...
                                                                try :	
                                                                        ...
                                                                        while Coach_ID not in Coaches_DataBase :
                                                                                Coach_ID = int(input("Incorrect ID, Please Enter Coach ID : "))
                                                                        print("-----------------------------------------")
                                                                        print("-$ 1. To Edit coach's name              |")
                                                                        print("-$ 2. To Edit coach's address           |")
                                                                        print("-$ 3. To Edit coach's phone number      |")
                                                                        print("-$ E. To be Back                        |")
                                                                        print("-----------------------------------------")
                                                                        Admin_choice=input("Enter your choice : ")
                                                                        Admin_choice = Admin_choice.upper()
                                                ...
                                                print("-$ 2. To edit an appointment            |")
                                                ...
                                                if Admin_choice == "1" :																		
                                                        try :		
                                                                        ...
                                                                        print("---------------------------------------------------------")
                                                                        print("-$ 1. For book an appointment for an exist member   |\n-$ 2. For book an appointment for a new member      |\n-$ E. To be Back                                     |")
                                                                        print("---------------------------------------------------------")
                                                                        Admin_choice = input ("Enter your choice : ")
                                                                        Admin_choice = Admin_choice.upper()
                                                                        if Admin_choice == "1" :
                ...
                while True :
                        print("\n-----------------------------------------")
                        print("-$ 1. To view studio's programs         |")
                        print("-$ 2. To view studio's coaches          |")
                        print("-$ 3. To view studio s' residents       |")
                        print("-$ 4. To view member's details          |")
                        print("-$ 5. To view coach's appointments      |")
                        print("-$ E. To be Back                        |")
                        print("-----------------------------------------")
                        ...
                        if   UserOptions == "1" :											
                                ...
                                for i in Members_DataBase :
                                        print("	Member : "+Members_DataBase[i][2]+" in "+Members_DataBase[i][0]+" program and followed by "+Members_DataBase[i][1]+", age : "+Members_DataBase[i][3]+", from : "+Members_DataBase[i][5]+", Phone Number :"+Members_DataBase[i][8])
